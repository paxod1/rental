                ...
                <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 mb-4 sm:mb-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                        ...
                        <div className="flex items-end sm:col-span-2 lg:col-span-1">
                            <button
                                onClick={clearSearch}
                                className="w-full bg-[#086cbe] hover:bg-[#0757a8] cursor-pointer text-white px-4 py-2 rounded-lg transition-colors flex items-center justify-center gap-2 text-sm sm:text-base lg:text-lg"
                            >
                                    ...
                                    <div className="hidden lg:flex items-center justify-between">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-3 mb-3">
                                                ...
                                                <div className="min-w-0 flex-1">
                                                    <h3 className="text-lg lg:text-2xl font-bold text-gray-800 uppercase truncate">
                                                        {rental.customerName || 'Unknown Customer'}
                                                    </h3>
                                                    <div className="flex items-center gap-4 text-sm lg:text-lg text-gray-600 mt-1">
                                                        {rental.customerPhone && (
                                            ...
                                            <div className="flex items-start gap-2">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <p className="text-sm lg:text-lg font-bold text-gray-700 mb-1">
